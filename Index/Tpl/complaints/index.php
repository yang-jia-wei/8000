...
<div class="g00002">
  ...
  <div class="g00004">
    ...
    <div class="c1448872173">
      ...
      <div class="f14474578231">
      	<div><span><?php $classify=M('classify')->where(array('classify_id'=>$classify_id))->find(); echo $classify['classify_name'];?></span></div>
      </div>
        <form action="index.php?m=message&a=add_save" method="post" enctype="multipart/form-data" onsubmit="return return_message()" id="form" class="f14488721902">
          <input name="data[type_id]" type="hidden" id="type_id" class="f14488721903" value="<?php echo $type_id;?>" />
          ...
          <div class="f14488721906">
            ...
            <dl class="f14488721907">
              <dt class="f14488721908"><?php echo $v['input_name']?><span>*</span></dt>
		...
		?>
        <label>
        <input type="checkbox" name="data[<?php echo $v['field_name'];?>][]" value="<?php echo $v2['input_id']?>" />
		...
		?>
        <label>
        <input type="radio" name="data[<?php echo $v['field_name'];?>]" value="<?php echo $v2['input_id']?>" />
        <?php echo $v2['input_name'];?>
        </label>&nbsp;&nbsp;
        <?php } ?>
        <?php
