...
<div class="g00002">
  <div class="f14464848051">
    <ul class="f14464848052">
      <?php  $goods = M('goods')->where(array('goods_name'=>array('like','%'.$search.'%')))->select(); $total_num=M('goods')->where(array('goods_name'=>array('like','%'.$search.'%')))->count(); foreach($goods as $k=>$v){ if(($k+1)%2==1 || ($k+1)==1){ echo '<div style="overflow:hidden;">';} ?>
