<?php require APP_ROOT.'public/top.php';?>
    ...
    <div class="content">
      ...
      <?php  $news_gt = M()->table('index_news n,index_relevance r')->where('r.classify_id ='.$classify_id.' and n.date > '.$news['date'].' and r.content_id=n.news_id')->order('date desc')->find(); 
