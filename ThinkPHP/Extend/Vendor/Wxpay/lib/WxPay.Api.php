...
/*$rs=dirname(__FILE__);
require_once $rs.'/WxPay.Exception.php';
require_once $rs.'/WxPay.Data.php';
require_once $rs.'/WxPay.config.php';
require_once $rs.'/WxPay.Notify.php';*/
...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$inputObj->SetMch_id($inputObj->GetMch_id());//商户号
